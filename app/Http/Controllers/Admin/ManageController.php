...
class ManageController extends AdminController
{
    ...
    */
	...
	private function saveData_cog(Request $request)
	{
		...
		$satst= 'APP_NAME,APP_NAMEADMIN,APP_URL,APP_URLY,APP_URLLOCAL,APP_LOGO,APP_DEBUG,APP_OPENREG,ROCK_SMSPROVIDER,APP_ENV,ROCK_RANDKEY,ROCK_URLY,ROCK_XINHUKEY,ALLOW_ORIGIN,ROCKOFFICE_URL,ROCKOFFICE_KEY,ROCKOFFICE_VIEW,ROCK_YZMLOGIN,ACCESS_WHITEIP,ACCESS_BLACKIP';
		$savea= explode(',', $satst);
		$path = base_path('.env');
