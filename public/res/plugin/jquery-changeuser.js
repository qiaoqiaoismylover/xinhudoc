...
(function ($) {
	...
	function selectdata(sobj, options){
		...
		this._showcreate = function(){
			...
			s+='<div tsid="main" id="mints_'+rand+'" style="position:absolute;top:30%; background:white;width:'+ws+';box-shadow:0px 0px 8px rgba(0,0,0,0.3)">';
			s+='	<div class="list-group-item active" style="border-radius:0" onmousedown="js.move(\'mints_'+rand+'\')">'+this.title+'</div>';
